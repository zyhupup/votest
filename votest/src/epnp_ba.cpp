...
int main ( int argc, char** argv )
{
    ...
    // 建立3D点
    Mat d1 = imread ( "/home/fsdh/桌面/slambook-master/ch7/2_depth.png", CV_LOAD_IMAGE_UNCHANGED );       // 深度图为16位无符号数，单通道图像
    ...
    Mat& R, Mat& t )
{
    // 初始化g2o
    //
    // typedef g2o::BlockSolver< g2o::BlockSolverTraits<6,3> > Block;  // pose 维度为 6, landmark 维度为 3 旧版
